...
import * as fromNavigation from '@app/redux/reducers/navigations.reducer';
import * as fromNotes from '@app/redux/reducers/notes.reducer';
import * as fromNoteDetail from '@app/redux/reducers/note-detail.reducer';
